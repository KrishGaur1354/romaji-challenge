export const hiraganaData = [
  ...
  { character: "ほん", romaji: "hon", tip: "Means 'book'" },
  { character: "つき", romaji: "tsuki", tip: "Means 'moon'" },
  { character: "そら", romaji: "sora", tip: "Means 'sky'" },
  { character: "ひと", romaji: "hito", tip: "Means 'person'" },
  { character: "こども", romaji: "kodomo", tip: "Means 'child'" },
  { character: "がっこう", romaji: "gakkou", tip: "Means 'school'" },
  { character: "せんせい", romaji: "sensei", tip: "Means 'teacher'" },
  { character: "ともだち", romaji: "tomodachi", tip: "Means 'friend'" },
  { character: "かぞく", romaji: "kazoku", tip: "Means 'family'" },
  { character: "おかあさん", romaji: "okaasan", tip: "Means 'mother'" },
  { character: "おとうさん", romaji: "otousan", tip: "Means 'father'" },
  { character: "いえ", romaji: "ie", tip: "Means 'house'" },
  { character: "まち", romaji: "machi", tip: "Means 'town' or 'city'" },
  { character: "にほん", romaji: "nihon", tip: "Means 'Japan'" },
  { character: "でんわ", romaji: "denwa", tip: "Means 'telephone'" },
  { character: "テレビ", romaji: "terebi", tip: "Means 'television'" },
  { character: "かばん", romaji: "kaban", tip: "Means 'bag'" },
  { character: "えんぴつ", romaji: "enpitsu", tip: "Means 'pencil'" },
  { character: "かみ", romaji: "kami", tip: "Means 'paper'" },
  { character: "つくえ", romaji: "tsukue", tip: "Means 'desk'" },
  { character: "いす", romaji: "isu", tip: "Means 'chair'" },
  { character: "まど", romaji: "mado", tip: "Means 'window'" },
  { character: "ドア", romaji: "doa", tip: "Means 'door'" },
  { character: "へや", romaji: "heya", tip: "Means 'room'" },
  { character: "たべもの", romaji: "tabemono", tip: "Means 'food'" },
  { character: "のみもの", romaji: "nomimono", tip: "Means 'drink'" },
  { character: "あさ", romaji: "asa", tip: "Means 'morning'" },
  { character: "ひる", romaji: "hiru", tip: "Means 'noon' or 'daytime'" },
  { character: "よる", romaji: "yoru", tip: "Means 'night'" },
  { character: "きょう", romaji: "kyou", tip: "Means 'today'" },
  { character: "あした", romaji: "ashita", tip: "Means 'tomorrow'" },
  { character: "きのう", romaji: "kinou", tip: "Means 'yesterday'" }
];
...
export const katakanaData = [
  ...
  // Easy Words (40+ items) - includes loanwords
  ...
  { character: "コーヒー", romaji: "koohii", tip: "Means 'coffee' (loanword)" },
  { character: "パン", romaji: "pan", tip: "Means 'bread' (loanword)" },
  { character: "ミルク", romaji: "miruku", tip: "Means 'milk' (loanword)" },
  { character: "ケーキ", romaji: "keeki", tip: "Means 'cake' (loanword)" },
  { character: "スープ", romaji: "suupu", tip: "Means 'soup' (loanword)" },
  { character: "サラダ", romaji: "sarada", tip: "Means 'salad' (loanword)" },
  { character: "テーブル", romaji: "teeburu", tip: "Means 'table' (loanword)" },
  { character: "チェア", romaji: "chea", tip: "Means 'chair' (loanword)" },
  { character: "ドア", romaji: "doa", tip: "Means 'door' (loanword)" },
  { character: "ウィンドウ", romaji: "windou", tip: "Means 'window' (loanword)" },
  { character: "コンピューター", romaji: "konpyuutaa", tip: "Means 'computer' (loanword)" },
  { character: "テレビ", romaji: "terebi", tip: "Means 'television' (loanword)" },
  { character: "ラジオ", romaji: "rajio", tip: "Means 'radio' (loanword)" },
  { character: "カメラ", romaji: "kamera", tip: "Means 'camera' (loanword)" },
  { character: "ノート", romaji: "nooto", tip: "Means 'notebook' (loanword)" },
  { character: "ペン", romaji: "pen", tip: "Means 'pen' (loanword)" },
  { character: "バス", romaji: "basu", tip: "Means 'bus' (loanword)" },
  { character: "タクシー", romaji: "takushii", tip: "Means 'taxi' (loanword)" },
  { character: "ホテル", romaji: "hoteru", tip: "Means 'hotel' (loanword)" },
  { character: "レストラン", romaji: "resutoran", tip: "Means 'restaurant' (loanword)" },
  { character: "カフェ", romaji: "kafe", tip: "Means 'cafe' (loanword)" },
  { character: "スーパー", romaji: "suupaa", tip: "Means 'supermarket' (loanword)" },
  { character: "エレベーター", romaji: "erebeetaa", tip: "Means 'elevator' (loanword)" },
  { character: "アパート", romaji: "apaato", tip: "Means 'apartment' (loanword)" },
  { character: "ビル", romaji: "biru", tip: "Means 'building' (loanword)" },
  { character: "パーク", romaji: "paaku", tip: "Means 'park' (loanword)" },
  { character: "スポーツ", romaji: "supootsu", tip: "Means 'sports' (loanword)" },
  { character: "ゲーム", romaji: "geemu", tip: "Means 'game' (loanword)" },
  { character: "ミュージック", romaji: "myuujikku", tip: "Means 'music' (loanword)" },
  { character: "ピアノ", romaji: "piano", tip: "Means 'piano' (loanword)" },
  { character: "ギター", romaji: "gitaa", tip: "Means 'guitar' (loanword)" }
];